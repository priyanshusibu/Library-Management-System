...
public class ReturnBook extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(i>0){
			out.println("<h3 style=\"font-size: 24px; font-weight: bold; color: #00698f; text-align: center; margin-bottom: 10px; padding: 10px; border-bottom: 2px solid #ccc; background-color: #f7f7f7; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);\">Book returned successfully</h3>");
		}else{
