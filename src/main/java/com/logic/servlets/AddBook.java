...
public class AddBook extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(i>0){
			out.println("<h3 style=\"color: green; background-color: #d4edda; padding: 10px; border: 1px solid #c3e6cb; border-radius: 5px; display: inline-block; transition: transform 0.3s ease;\">\r\n"
